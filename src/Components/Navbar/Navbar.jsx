...
export default function Navbar() {
  return (
    <Disclosure as="nav" className="bg-gray-800">
      {({ open }) => (
        <>
          <div className="mx-auto max-w-7xl px-2 sm:px-6 sm:mt-12  lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div>
                <h3
                  className="font-semibold font-figtree hidden md:block"
                  style={{ fontSize: '24px' }}
                >
                  Upload CSV
                </h3>
          ...
          <Disclosure.Panel className="sm:hidden ml-7">
